 ...
 */
package mx.gob.imss.dpes.evento.config;
...
public class ApplicationConfig extends Application {
    ...
    resources.add(mx.gob.imss.dpes.evento.endpoint.BitacoraInterfazTopicEndPoint.class);
    resources.add(mx.gob.imss.dpes.evento.endpoint.EventoEndPoint.class);
    }
